...
The dashboard is a data visualizer integrated into yooba, intended to collect and visualize useful information of an Yooba node. It consists of two parts:
