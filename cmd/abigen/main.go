...
import (
	...
	"github.com/yooba-team/yooba/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Yooba contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Yooba contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Yooba contract Solidity source to build and bind")
