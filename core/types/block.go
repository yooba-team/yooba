...
// Package types contains data types related to Yooba consensus.
package types
...
// EncodeRLP serializes b into the Yooba RLP block format.
...
[
	...
	MixDigest:      %x
	Nonce:		    %x
]`, h.Hash(), h.ParentHash, h.Coinbase, h.Root, h.TxHash, h.ReceiptHash, h.Bloom,h.Number, h.GasLimit, h.GasUsed, h.Time, h.Extra, h.MixDigest, h.Nonce)
}
