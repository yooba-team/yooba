...
//	)
//	if full {
//		blockChainB = makeBlockChain(blockchain2.CurrentBlock(), n, dpos.Default(), db, forkSeed)
//		if _, err := blockchain2.InsertChain(blockChainB); err != nil {
//			t.Fatalf("failed to insert forking chain: %v", err)
//		}
//	} else {
//		headerChainB = makeHeaderChain(blockchain2.CurrentHeader(), n, dpos.Default(), db, forkSeed)
...
//
//			blockchain.engine = dpos.NewFakeFailer(failNum)
...
//	var (
//		gendb, _ = yoobadb.NewMemDatabase()
...
//		if i%3 == 2 {
//			for j := 0; j < i%4+1; j++ {
//				tx, err := types.SignTx(types.NewTransaction(block.TxNonce(address), common.Address{0x00}, big.NewInt(1000), params.TxGas, nil, types.TxTypeTransfer,nil), signer, key)
//				if err != nil {
//					panic(err)
//				}
//				block.AddTx(tx)
...
//	archiveDb, _ := yoobadb.NewMemDatabase()
...
//	fastDb, _ := yoobadb.NewMemDatabase()
...
//	lightDb, _ := yoobadb.NewMemDatabase()
...
//	postponed, _ := types.SignTx(types.NewTransaction(0, addr1, big.NewInt(1000), params.TxGas, nil, types.TxTypeTransfer,nil), signer, key1)
//	swapped, _ := types.SignTx(types.NewTransaction(1, addr1, big.NewInt(1000), params.TxGas, nil, types.TxTypeTransfer,nil), signer, key1)
//
...
//		switch i {
//		case 0:
//			pastDrop, _ = types.SignTx(types.NewTransaction(gen.TxNonce(addr2), addr2, big.NewInt(1000), params.TxGas,nil, types.TxTypeTransfer,nil), signer, key2)
//
//			gen.AddTx(pastDrop)  // This transaction will be dropped in the fork from below the split point
//			gen.AddTx(postponed) // This transaction will be postponed till block #3 in the fork
//
//		case 2:
//			freshDrop, _ = types.SignTx(types.NewTransaction(gen.TxNonce(addr2), addr2, big.NewInt(1000), params.TxGas, nil, types.TxTypeTransfer,nil), signer, key2)
//
...
//		switch i {
//		case 0:
//			pastAdd, _ = types.SignTx(types.NewTransaction(gen.TxNonce(addr3), addr3, big.NewInt(1000), params.TxGas, nil, types.TxTypeTransfer,nil), signer, key3)
...
//
//			freshAdd, _ = types.SignTx(types.NewTransaction(gen.TxNonce(addr3), addr3, big.NewInt(1000), params.TxGas, nil, types.TxTypeTransfer,nil), signer, key3)
//			gen.AddTx(freshAdd) // This transaction will be added exactly at reorg time
//
//		case 3:
//			futureAdd, _ = types.SignTx(types.NewTransaction(gen.TxNonce(addr3), addr3, big.NewInt(1000), params.TxGas, nil, types.TxTypeTransfer,nil), signer, key3)
...
//	defer bc.Stop()
//
//	chain, _ := GenerateChain(bc.chainConfig, bc.genesisBlock, dpos.NewFaker(), bc.db, 10, func(i int, gen *BlockGen) {})
//
...
////
//// https://github.com/yooba-team/yooba/pull/15941
