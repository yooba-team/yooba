...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := yoobadb.NewMemDatabase()
	finalDb := yoobadb.NewMemDatabase()
...
// https://github.com/yooba-team/yooba/pull/15549.
func TestCopy(t *testing.T) {
	// Create a random state test to copy and modify "independently"
	orig, _ := New(common.Hash{}, NewDatabase(yoobadb.NewMemDatabase()))
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(yoobadb.NewMemDatabase()))
...
// See https://github.com/yooba-team/yooba/pull/15225#issuecomment-380191512
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(yoobadb.NewMemDatabase()))
