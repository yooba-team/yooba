...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(yoobadb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db yoobadb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db yoobadb.Database, root common.Hash) error {
...
func checkStateConsistency(db yoobadb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, yoobadb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(yoobadb.Database), srcRoot)
