...
type Database struct {
	diskdb yoobadb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb yoobadb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch yoobadb.Batch) error {
	// If the node does not exist, it's a previously committed node
