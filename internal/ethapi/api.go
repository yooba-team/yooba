...
// PublicEthereumAPI provides an API to access Yooba related information.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicEthereumAPI struct {
	b Backend
}

// NewPublicEthereumAPI creates a new Yooba protocol API.
...
// ProtocolVersion returns the current Yooba protocol version this node supports
...
// Sign calculates an Yooba ECDSA signature for:
...
// PublicBlockChainAPI provides an API to access the Yooba blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new Yooba blockchain API.
...
// PublicDebugAPI is the collection of Yooba APIs exposed over the public
// debugging endpoint.
...
// PrivateDebugAPI is the collection of yooba APIs exposed over the private
// debugging endpoint.
...
// Version returns the current Yooba protocol version.
