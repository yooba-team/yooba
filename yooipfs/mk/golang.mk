...
go-pkg-name=$(shell $(GOCC) list $(go-tags) github.com/yooba-team/yooba/yooipfs/$(1))
go-main-name=$(notdir $(call go-pkg-name,$(1)))$(?exe)
go-curr-pkg-tgt=$(d)/$(call go-main-name,$(d))
go-pkgs-novendor=$(shell $(GOCC) list github.com/yooba-team/yooba/yooipfs... | grep -v /Godeps/)
...
check_go_path:
	bin/check_go_path $(realpath $(shell pwd)) $(realpath $(addsuffix /src/github.com/yooba-team/yooba/yooipfs,$(subst $(PATH_SEP),$(space),$(GOPATH))))
.PHONY: check_go_path
