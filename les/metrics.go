...
var (
	/*	propTxnInPacketsMeter     = metrics.NewMeter("yoo/prop/txns/in/packets")
		...
		reqHashInPacketsMeter     = metrics.NewMeter("yoo/req/hashes/in/packets")
		reqHashInTrafficMeter     = metrics.NewMeter("yoo/req/hashes/in/traffic")
		reqHashOutPacketsMeter    = metrics.NewMeter("yoo/req/hashes/out/packets")
		reqHashOutTrafficMeter    = metrics.NewMeter("yoo/req/hashes/out/traffic")
		reqBlockInPacketsMeter    = metrics.NewMeter("yoo/req/blocks/in/packets")
		reqBlockInTrafficMeter    = metrics.NewMeter("yoo/req/blocks/in/traffic")
		reqBlockOutPacketsMeter   = metrics.NewMeter("yoo/req/blocks/out/packets")
		reqBlockOutTrafficMeter   = metrics.NewMeter("yoo/req/blocks/out/traffic")
