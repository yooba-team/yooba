...
// ecrecover extracts the Yooba account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Yooba address
...
// Yooba testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     yoobadb.Database     // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Yooba address of the signing key
...
func New(config *params.CliqueConfig, db yoobadb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Yooba address recovered
